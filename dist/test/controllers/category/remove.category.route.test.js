...
describe('Category - Remove | DELETE /category/:_id', () => {
    ...
    it('Can remove category', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('Cannot remove a category with invalid id', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield supertest_1.default(app_1.app)
            .delete('/category/' + 'idCategory')
            .set({ token });
        const { success, category, message } = response.body;
    ...
    it('Cannot remove a category with invalid token || empty token', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield supertest_1.default(app_1.app)
            .delete('/category/' + idCategory);
        // .set({ token });
        const { success, category, message } = response.body;
    ...
    it('Cannot remove a removed category', () => __awaiter(this, void 0, void 0, function* () {
