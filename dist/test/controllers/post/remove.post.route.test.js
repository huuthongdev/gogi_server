...
describe('Post - Remove | DELETE /:_id', () => {
    ...
    it('Can remove a post', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('Cannot remove post with invalid id', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield supertest_1.default(app_1.app)
            .delete('/post/' + 'idPost')
            .set({ token });
        const { success, post, message } = response.body;
    ...
    it('Cannot remove post with invalid token', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield supertest_1.default(app_1.app)
            .delete('/post/' + idPost)
            .set({ token: '123asd' });
        const { success, post, message } = response.body;
    ...
    it('Cannot remove a removed post', () => __awaiter(this, void 0, void 0, function* () {
